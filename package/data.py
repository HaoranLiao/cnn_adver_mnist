...
class DataGenerator:
    ...
    def flatten_images(self):
        self.train_images = flatten_images(self.train_images)
        self.test_images = flatten_images(self.test_images)
...
def flatten_images(images):
    ...
    return flattened_image[..., None]


def flatten_single_image(image):
    flattened_image = np.reshape(image, [-1])
    flattened_image = flattened_image[None, ...]
    return flattened_image[..., None]
